...
export const PatientUpdateModal: React.FC<PatientUpdateModalProps> = ({
  ...
  const handleSaveAllUpdates = async () => {
    ...
    const updatePayload: SubmissionPayload = {
      ...
      "Tgl berkunjung difaskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      "Tgl berkunjung di faskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      "Tgl berkunjung faskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      "Tgl berkunjung ke faskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      "Tgl Kunjung Faskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      "Tanggal berkunjung difaskes": tanggalBerkunjungFaskes || patient.tanggalBerkunjungFaskes || rawData.tanggalBerkunjungFaskes || "",
      ...
      "Kelurahan Domisili": patient.kelurahanDomisili || rawData.kelurahanDomisili || patient.kelurahan || "",
      "Kecamatan domisili korban": patient.kecamatanDomisili || rawData.kecamatanDomisili || patient.kecamatan || "",
      "Kecamatan Domisili": patient.kecamatanDomisili || rawData.kecamatanDomisili || patient.kecamatan || "",
      "Kab kota korban": patient.kabupatenKotaDomisili || rawData.kabupatenKotaDomisili || patient.kabupatenKota || "",
      "Kabupaten/Kota Domisili": patient.kabupatenKotaDomisili || rawData.kabupatenKotaDomisili || patient.kabupatenKota || "",
      "Kab Kota Domisili": patient.kabupatenKotaDomisili || rawData.kabupatenKotaDomisili || patient.kabupatenKota || "",
      "Provinsi domisili korban": patient.provinsiDomisili || rawData.provinsiDomisili || "Jawa Timur",
      "Provinsi Domisili": patient.provinsiDomisili || rawData.provinsiDomisili || "Jawa Timur",
